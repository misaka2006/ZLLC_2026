...
uint8_t CAN1_0x4FE_Tx_Data[8];//一拖四模式
uint8_t CAN1_ENABLE[8] = {0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfc};
...
//		if(mod_init==10)
//		{
//			CAN_Send_Data(&hcan1,0x06,DM_Motor_CAN_Message_Enter,8);
//			mod_init=0;
//		}
    // CAN2
    if (mod % 7 == 1)
    {
        //CAN_Send_Data(&hcan2, 0x01, CAN2_Gimbal_Tx_Chassis_Data, 8); // 给底盘发送控制命令 按照0x77 ID 发送
