...
//清除电机错误信息
extern uint8_t DM_Motor_CAN_Message_Clear_Error[8];
//使能电机
extern uint8_t DM_Motor_CAN_Message_Enter[8];
//失能电机
extern uint8_t DM_Motor_CAN_Message_Exit[8];
//保存当前电机位置为零点
extern uint8_t DM_Motor_CAN_Message_Save_Zero[8];
...
enum Enum_DM_Motor_Control_Method
{
    ...
    #ifdef DM_EMIT_BIN
    DM_Motor_Control_Method_EMIT_OMEGA,
    DM_Motor_Control_Method_EMIT_ANGLE,
    #endif 
};
...
protected:
    ...
    //一圈位置刻度
    uint32_t Encoder_Num_Per_Round = (DM_Motor_Control_Method == DM_Motor_Control_Method_ONE_TO_FOUR)?8192:65536;
    //对于65536这个数字，我持怀疑态度，我没找到这个数字，用一拖四，是8192，可以查到
    ...
    //电机控制方式
    Enum_DM_Motor_Control_Method DM_Motor_Control_Method = DM_Motor_Control_Method_ONE_TO_FOUR;
